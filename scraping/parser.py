...
# USED https://www.crummy.com/software/BeautifulSoup/bs4/doc/
...
def _pick_calendar_table(soup):
	"""Has multiple tables - pick the one with the most rows"""
...
class ForexFactoryParser:
	def parse_calendar_page(self, html):
		"""Parse table.calendar__table: main row fields + tr.calendar__details"""
		...
		for tr in _iter_main_calendar_rows(table):
			...
			# html uses 2 ways to show date. Support both.
